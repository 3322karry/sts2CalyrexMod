...
## v1.2.41.107.1 (2026-09-19)

### Changes / 改动
- 修复：其他角色卡牌描述的能量图标不再被替换为蕾冠王图标（仅 calyrex 前缀使用自定义图标）

## v1.2.40.107.1 (2026-08-29)
...
### 首发版本
- **角色**：蕾冠王完整可玩角色
- **第 8 批卡牌**（黑雾/归零/铁壁/飞翔/花粉团/不服输/流星群/珍藏/泼沙/扑击/回响嘶鸣/Z-庆祝/自我暗示/聚光灯/招式记录/冰柱坠击/三旋击/精神噪音）与先古牌（牵绊缰绳/勇气绳索/再来一次/调试）
